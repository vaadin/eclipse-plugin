...
/**
 * Manual test runner that can be executed in Eclipse to validate the REST API functionality.
 * This class provides a simple way to test the integration without requiring complex test infrastructure.
 * 
