...
/**
 * Tests for advanced endpoint implementations including
 * project analysis, compilation, and application management.
 */
public class AdvancedEndpointsTest extends BaseIntegrationTest {
    ...
    public void testGetModulePathsEndpoint() throws Exception {
        ...
        IClasspathEntry[] entries = new IClasspathEntry[] {
            JavaCore.newSourceEntry(srcMain.getFullPath()),
            JavaCore.newSourceEntry(srcTest.getFullPath()),
            JavaCore.newSourceEntry(resources.getFullPath())
        };
    ...
    public void testGetVaadinEntitiesEndpoint() throws Exception {
        ...
        createJavaClass("src", "com.example.model", "TestEntity",
    ...
    public void testRestartApplicationEndpoint() throws Exception {
        ...
        assertTrue("Message should indicate no config found", 
            message.contains("No launch configuration"));
    }
