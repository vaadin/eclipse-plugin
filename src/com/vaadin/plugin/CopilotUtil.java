...
public class CopilotUtil {
    ...
    public static String getSupportedActions() {
        String[] actions = {
            "write", "writeBase64", "delete", "undo", "redo", "refresh", 
            "showInIde", "getModulePaths", "compileFiles", "restartApplication",
            "getVaadinRoutes", "getVaadinVersion", "getVaadinComponents", 
