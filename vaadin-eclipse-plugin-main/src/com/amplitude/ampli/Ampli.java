...
public class Ampli {
    ...
    public void _identify(String userId) {
        this.identify(userId, null, null);
    }

    public void _identify(String userId, EventOptions options) {
        this.identify(userId, options, null);
    }

    public void _identify(String userId, MiddlewareExtra extra) {
        this.identify(userId, null, extra);
    }

    public void _identify(String userId, EventOptions options, MiddlewareExtra extra) {
        if (!this.isInitializedAndEnabled()) {
            return;
        }
